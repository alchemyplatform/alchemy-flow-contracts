...
Momentables)
  echo "Momentables"
  flow scripts execute getNFTs.cdc --args-json '[{ "type": "Address", "value": "0xab67ebb860262f30" }, { "type": "Dictionary", "value": [{ "key": { "type": "String", "value": "Momentables" }, "value": { "type": "Array", "value": [{ "type": "UInt64", "value": "659" }] } }] }]' --network mainnet
  ;;
