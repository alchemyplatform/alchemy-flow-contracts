...
ARTIFACTPackV2)
  echo "ARTIFACTPackV2"
  flow scripts execute getNFTs.cdc --args-json '[{ "type": "Address", "value": "0xd9cccb588a70de71" }, { "type": "Dictionary", "value": [{ "key": { "type": "String", "value": "ARTIFACTPackV2" }, "value": { "type": "Array", "value": [{ "type": "UInt64", "value": "1" }] } }] }]' --network mainnet
  ;;

ARTIFACTV2)
  echo "ARTIFACTV2"
  flow scripts execute getNFTs.cdc --args-json '[{ "type": "Address", "value": "0xd9cccb588a70de71" }, { "type": "Dictionary", "value": [{ "key": { "type": "String", "value": "ARTIFACTV2" }, "value": { "type": "Array", "value": [{ "type": "UInt64", "value": "1" }] } }] }]' --network mainnet
  ;;
...
MetaPanda)
  echo "MetaPanda"
  flow scripts execute getNFTs.cdc --args-json '[{ "type": "Address", "value": "0xf2af175e411dfff8" }, { "type": "Dictionary", "value": [{ "key": { "type": "String", "value": "MetaPanda" }, "value": { "type": "Array", "value": [{ "type": "UInt64", "value": "1793" }] } }] }]' --network mainnet
ByteNextMedalNFT)
